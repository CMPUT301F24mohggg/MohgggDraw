...
public class ManageListFragment2 extends Fragment {
    ...
    private void updateTabStyles(List<TextView> tabs, int selectedIndex) {
        for (int i = 0; i < tabs.size(); i++) {
            ...
            if (i == selectedIndex) {
                ...
                tab.setTextColor(ContextCompat.getColor(requireContext(), R.color.purple_500));
                tab.setBackgroundResource(R.drawable.tab_selected_background);
            } else {
                // Reset styles for unselected tabs
